...
This construction ensures that, at the $k$-th step we have a weight $w^k$ w.r.t. the intermediate density $\gamma^k(z^{1:k})$ of the form (see Appendix~\ref{appendix:sis-weight}. for a full derivation)
\begin{align*}
    w^k
    =
    \frac{\gamma^k(z^{1:k})}
