...
Next we consider a deep generative mixture model (DMM) that incorporates a neural likelihood. We use APG samplers to jointly train the generative model and inference model and were able to perform accurate perform scalable inference to test-time instances with 600 points. 
