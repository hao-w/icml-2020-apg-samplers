...
In the following we will describe an adaptive importance sampling scheme to obtaining high quality samples to accurately estimate gradients for the conditional proposal $q_\f(z_b | x, z_{-b})$ and a one-shot encoder $q_\f(z | x)$ which we will use to obtain an initial set of samples.
